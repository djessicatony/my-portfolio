          ...
          <div className="max-w-xl w-full space-y-10">
            <div className="space-y-2">
              ...
              <p className="text-xl text-foreground leading-relaxed mb-4">
                I&apos;m a co-founder of Aerovalent, passionate about building cool things with code & Travis Scott :)
              </p>
              <p className="text-lg text-foreground mb-4">
                Currently working on aerovalent — cursor for your inboxes. Pulls actual tasks from your conversations to kanban-based taskboard. No overload. No dozen tabs. Just you and your tasks.
              </p>
              <p className="text-lg text-foreground mb-4">
