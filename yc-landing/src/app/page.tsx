        ...
        <div className="flex flex-col md:flex-row items-start gap-20 w-full max-w-6xl px-6">
          <div className="max-w-xl w-full space-y-10">
            ...
            <div className="flex flex-wrap gap-4 mt-6 mb-4">
              ...
              <a href="https://www.linkedin.com/in/kirillm-ml" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors">
                ...
                <span>linkedin.com/in/kirillm-ml</span>
              </a>
